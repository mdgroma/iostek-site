    ...
    <>
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-14 px-6 py-16 lg:grid-cols-[1.05fr_0.95fr] lg:py-20">
          <div>
            ...
            <h1 className="mt-5 text-[2.4rem] font-bold leading-[1.1] tracking-tight sm:text-5xl lg:text-[3.3rem]">
              Software su misura e <span className="text-accent">automazione AI</span> per la tua azienda.
            </h1>
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              <Link href="/contatti" className="rounded-full bg-accent px-6 py-3.5 text-base font-semibold text-white shadow-[0_12px_30px_rgba(42,67,232,0.28)] transition-transform hover:scale-[1.03]">
            ...
            <p className="mt-8 eyebrow text-stone-500">35 anni · Italia · UK · Silicon Valley</p>
          </div>
      ...
      <section className="border-y border-ink/5 bg-white">
        <div className="mx-auto max-w-6xl px-6 py-10">
          <p className="eyebrow text-stone-500">Esperienza maturata su progetti e piattaforme per</p>
          <div className="mt-5 flex flex-wrap items-center gap-x-8 gap-y-3 text-sm font-semibold text-stone-400">
        ...
        <div className="mx-auto max-w-6xl px-6 py-20">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="ring-card rounded-3xl border border-ink/5 bg-white p-8">
              <span className="eyebrow text-stone-500">01</span>
              <h3 className="mt-2 text-2xl font-semibold">Software su misura</h3>
              <p className="mt-2 leading-relaxed text-stone-600">App mobile iOS e Android (nativo e cross-platform), piattaforme SaaS, gestionali web e portali. Dalla progettazione dell&apos;architettura al deployment in produzione.</p>
              <p className="mt-4 eyebrow text-stone-500">Swift · SwiftUI · Flutter · Next.js · backend &amp; API</p>
            </div>

            <div className="ring-card rounded-3xl border border-accent/20 bg-gradient-to-br from-accent/[0.05] to-white p-8">
              <span className="eyebrow text-accent">02 · il cuore</span>
              <h3 className="mt-2 text-2xl font-semibold">Automazione AI &amp; agenti</h3>
              <p className="mt-2 leading-relaxed text-stone-600">Individuiamo i processi della tua azienda che l&apos;AI può automatizzare e costruiamo infrastrutture agentiche su misura — on-premise o private cloud. La tua AI, sui tuoi dati, integrata coi tuoi sistemi.</p>
              <p className="mt-4 text-sm font-semibold text-accent">Una tua AI in casa, non un abbonamento a una scatola nera.</p>
            </div>

            <div className="ring-card rounded-3xl border border-ink/5 bg-white p-8">
              <span className="eyebrow text-stone-500">03</span>
              <h3 className="mt-2 text-2xl font-semibold">Infrastrutture IT</h3>
              <p className="mt-2 leading-relaxed text-stone-600">Progettazione, installazione, gestione e manutenzione. Cloud, ibrido o on-premise: alta affidabilità, failover, backup, sicurezza e continuità operativa. Le teniamo in piedi noi.</p>
              <p className="mt-4 eyebrow text-stone-500">AWS · Azure · Hetzner · VMware · Linux · sicurezza</p>
            </div>

            <div className="ring-card rounded-3xl border border-ink/5 bg-white p-8">
              <span className="eyebrow text-stone-500">04</span>
              <h3 className="mt-2 text-2xl font-semibold">Integrazione enterprise</h3>
              <p className="mt-2 leading-relaxed text-stone-600">Far parlare i sistemi che oggi non si parlano: ERP, CRM, database, gateway di messaggistica. Oltre vent&apos;anni su middleware di integrazione e processi enterprise, anche in ambito bancario.</p>
              <p className="mt-4 eyebrow text-stone-500">EAI/BPM · ERP/CRM · SWIFT/FIN · ORACLE · DB2</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="ai" className="ink-section relative overflow-hidden text-paper">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-20">
          ...
          <div className="mt-14 grid gap-px overflow-hidden rounded-3xl border border-white/10 bg-white/10 sm:grid-cols-2 lg:grid-cols-5">
            <div className="bg-ink p-7"><div className="eyebrow text-accent2">01</div><h3 className="mt-3 text-lg font-semibold">Audit dei processi</h3><p className="mt-1.5 text-sm leading-relaxed text-stone-400">Guardiamo come lavori e troviamo dove l&apos;AI fa risparmiare tempo e soldi davvero.</p></div>
            <div className="bg-ink p-7"><div className="eyebrow text-accent2">02</div><h3 className="mt-3 text-lg font-semibold">Design infrastruttura</h3><p className="mt-1.5 text-sm leading-relaxed text-stone-400">Agenti su misura, non template. Architettura pensata sui tuoi sistemi e vincoli.</p></div>
            <div className="bg-ink p-7"><div className="eyebrow text-accent2">03</div><h3 className="mt-3 text-lg font-semibold">Installazione</h3><p className="mt-1.5 text-sm leading-relaxed text-stone-400">On-premise o private cloud. I tuoi dati restano dentro la tua azienda.</p></div>
            <div className="bg-ink p-7"><div className="eyebrow text-accent2">04</div><h3 className="mt-3 text-lg font-semibold">Integrazione</h3><p className="mt-1.5 text-sm leading-relaxed text-stone-400">Collegata a gestionali, posta, documenti e database. L&apos;AI lavora dove lavori tu.</p></div>
            <div className="bg-ink p-7"><div className="eyebrow text-accent2">05</div><h3 className="mt-3 text-lg font-semibold">Manutenzione</h3><p className="mt-1.5 text-sm leading-relaxed text-stone-400">La teniamo viva, aggiornata e la facciamo crescere con la tua azienda.</p></div>
          </div>

          <div className="mt-10">
            <Link href="/contatti" className="inline-flex items-center gap-2 rounded-full bg-accent px-6 py-3.5 text-base font-semibold text-white transition-transform hover:scale-[1.03]">
            ...
            <div>
              <div className="mb-6 flex items-center gap-4">
                <div className="relative h-16 w-16 overflow-hidden rounded-2xl bg-accent/10 ring-1 ring-ink/10">
                  <div className="flex h-full w-full items-center justify-center text-lg font-bold text-accent font-display">MDG</div>
                </div>
                <div>
                  <div className="font-semibold">Marco De Girolamo</div>
                  <div className="eyebrow text-stone-500">Founder · Senior Software Engineer</div>
                </div>
              </div>
              <p className="eyebrow text-accent">Esperienza</p>
              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                <div className="rounded-2xl bg-white p-5 ring-1 ring-ink/5"><div className="text-3xl font-semibold text-accent font-display">35+</div><div className="mt-1 text-sm font-medium text-stone-500">anni di esperienza</div></div>
                <div className="rounded-2xl bg-white p-5 ring-1 ring-ink/5"><div className="text-3xl font-semibold text-accent font-display">IT·UK·US</div><div className="mt-1 text-sm font-medium text-stone-500">progetti internazionali</div></div>
                <div className="rounded-2xl bg-white p-5 ring-1 ring-ink/5"><div className="text-3xl font-semibold text-accent font-display">20+</div><div className="mt-1 text-sm font-medium text-stone-500">dev coordinati</div></div>
              </div>
            </div>

            <div className="space-y-5">
              <div className="rounded-2xl border border-ink/5 bg-white p-6 ring-card"><div className="eyebrow text-accent">2021 → oggi</div><div className="mt-1 text-lg font-semibold">Mobile enterprise &amp; prodotti propri</div><p className="mt-1 text-sm leading-relaxed text-stone-600">App iOS enterprise per il fashion internazionale (Kering, Luxottica, Safilo) e sviluppo di prodotti SaaS proprietari come Mandascan.</p></div>
              <div className="rounded-2xl border border-ink/5 bg-white p-6 ring-card"><div className="eyebrow text-accent">2009 → 2021 · iOStek</div><div className="mt-1 text-lg font-semibold">Software &amp; infrastrutture per Italia e UK</div><p className="mt-1 text-sm leading-relaxed text-stone-600">Mobile banking (Mobank), portali logistici (WnDirect), 100+ siti mobile (Mopowered) coordinando team internazionali; progettazione e gestione di infrastrutture IT in alta affidabilità.</p></div>
              <div className="rounded-2xl border border-ink/5 bg-white p-6 ring-card"><div className="eyebrow text-accent">2000 → 2008 · Silicon Valley</div><div className="mt-1 text-lg font-semibold">Integrazione enterprise (EAI/BPM)</div><p className="mt-1 text-sm leading-relaxed text-stone-600">Solution Engineer per Vitria, SeeBeyond (oggi Oracle) e MicroStrategy: architetture di integrazione e business intelligence per banche, telco e grandi gruppi (Fastweb, BancaIMI, Banca Generali).</p></div>
              <div className="rounded-2xl border border-ink/5 bg-white p-6 ring-card"><div className="eyebrow text-accent">1989 → 2000</div><div className="mt-1 text-lg font-semibold">Sistemi bancari mainframe</div><p className="mt-1 text-sm leading-relaxed text-stone-600">Lead developer su COBOL, CICS/DB2 per gruppi bancari (Banca di Roma, BNL, ICCREA): centrale rischi, estero, migrazioni di sistemi informativi.</p></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="mandascan" className="bg-white">
        <div className="mx-auto max-w-6xl px-6 py-20">
          <p className="eyebrow text-accent">Prodotti</p>
          <div className="mt-3 grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <a href="https://mandascan.com" rel="noopener" className="mt-7 inline-flex items-center gap-2 rounded-full border border-accent/30 px-6 py-3.5 text-base font-semibold text-accent transition-colors hover:bg-accent/5">
                Scopri Mandascan →
              </a>
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-3xl bg-white ring-card border border-ink/5">
                <div className="flex items-center gap-1.5 border-b border-ink/5 px-4 py-3">
                  ...
                  <span className="ml-3 text-xs text-stone-400 font-mono">mandascan.com</span>
                </div>
        ...
        <div className="mx-auto max-w-5xl px-6 py-20">
          <div className="overflow-hidden rounded-[2rem] ink-section relative text-paper">
            ...
            <div className="relative px-8 py-16 text-center sm:px-16">
              ...
              <p className="mx-auto mt-4 max-w-xl text-lg text-stone-300">Una chiamata, nessun impegno. Capiamo se possiamo aiutarti davvero e come.</p>
              <div className="mt-9 flex flex-wrap justify-center gap-3">
                <a href="mailto:marco@iostek.com?subject=Progetto%20per%20iOStek" className="rounded-full bg-accent px-7 py-3.5 text-base font-semibold text-white shadow-[0_12px_30px_rgba(42,67,232,0.35)] transition-transform hover:scale-[1.03]">Scrivici: marco@iostek.com</a>
