  ...
  return (
    <main className="prose mx-auto max-w-3xl px-6 py-16">
      ...
      <p>
        ...
        <strong>non utilizza cookie di profilazione né strumenti di tracciamento o statistiche</strong>.
        L&apos;unico dato salvato sul tuo dispositivo è la tua scelta sull&apos;informativa cookie,
      ...
      <p>
        Al momento <strong>non</strong> utilizziamo strumenti di statistica. Qualora venissero
        introdotti, saranno elencati in questa pagina e attivati solo previo tuo consenso tramite il
        banner.
      </p>
