...
// Serve come URL corto per i DM e come URL "fresco" per le anteprime social:
// avendo un canonical proprio, LinkedIn/WhatsApp leggono l'immagine OG aggiornata
// senza ricadere sulla cache dell'URL lungo. Indicizzabile, perché gli scraper
// social rifiutano di generare l'anteprima delle pagine marcate "noindex".
